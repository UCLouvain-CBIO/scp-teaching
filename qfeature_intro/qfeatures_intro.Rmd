...
A **QFeatures** object containing three assays, named PSM1, PSM2 and
PSM3. Each assay contains quantitative data for a set of features
(rows) and samples (columns). The **QFeatures** object also contains
sample annotations matching columns across all assyas.
