...
<br> 
PSM quality control removes low-quality PSMs so to **improve the reliability**
...
Single-cell quality control removes failed cell so to **improve the reliability**
of downstream analysis results.
...
(n = 1000), where would you put a filtering threshold to remove 
low-quality cells?
...
Suppose you have stored that threshold in `value`, which command would
you used to remove low-quality cells?

```{r, eval = FALSE}
subsetByColData(scope2Data, scope2Data$medianCV < value)
subsetByColData(scope2Data, scope2Data$medianCV > value)
```
...
* Try it yourself in this free online workshop: 
