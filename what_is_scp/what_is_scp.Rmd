...
- It is part of the [Bioconductor](http://www.bioconductor.org/packages/scp)
  package - it is interoperable and thus benefits from numerous of
  software for the analysis of omics data, such as for example
  proteomcs of single cell transcriptomics.
